      ...
      panels: [
        {
          ...
          items: [
            { title: 'Tailings Storage Facility Safety Monitoring Solution', desc: '', href: 'solution-tailing.html' },
            { title: 'Open-pit Mine Slope Safety Monitoring Solution', desc: '', href: 'solutions-mining-pit.html' },
            { title: 'Waste Dump High Slope Safety Monitoring Solution', desc: '', href: 'solutions-mining-waste.html' },
            { title: 'Phosphogypsum Stack Online Monitoring Solution', desc: '', href: 'solutions-mining-chemical.html' },
            { title: 'Goaf Settlement & Displacement Monitoring Solution', desc: '', href: 'solutions-mining-goaf.html' },
          ],
        },
        {
          target: 'mega-solutions-water',
          items: [
            { title: 'Reservoir and Pond Online Monitoring Solution', desc: '', href: 'solutions-water-pond.html' },
            { title: 'Reservoir Slope Online Monitoring Solution', desc: '', href: 'solutions-water-slope.html' },
            { title: 'Reservoir Dam Safety Monitoring Solution', desc: '', href: 'solutions-water-dam.html' },
            { title: 'River and Lake Ecological Water Quality Monitoring Solution', desc: '', href: 'solutions-water-lake.html' },
            { title: 'Smart Irrigation District Integrated Monitoring Solution', desc: '', href: 'solutions-water-irrigation.html' },
            { title: 'Embankment Safety Online Monitoring Solution', desc: '', href: 'solutions-water-embankment.html' },
          ],
        },
        {
          target: 'mega-solutions-geo',
          items: [
            { title: 'Landslide Safety Monitoring Solution', desc: '', href: 'solutions-geo-landslide.html' },
            { title: 'Debris Flow & Flash Flood Monitoring Solution', desc: '', href: 'solutions-geo-flow.html' },
            { title: 'Rockfall & Collapse Online Monitoring Solution', desc: '', href: 'solutions-geo-collapse.html' },
          ],
        },
        {
          target: 'mega-solutions-urban',
          items: [
            { title: 'Bridge Structural Safety Online Monitoring Solution', desc: '', href: 'solutions-urban-bridge.html' },
            { title: 'Tunnel & Underground Space Monitoring Solution', desc: '', href: 'solutions-urban-tunnel.html' },
            { title: 'Integrated Building Structural Health Monitoring Solution', desc: '', href: 'solutions-urban-fundation.html' },
          ],
        },
      ],
    },
